            ...
            <div className="col-md-12">
              <div className="team-slider owl-carousel owl-theme">
                <div className="item">
                  <div className="team-box">
                    <div className="team-under-box">
                      <div className="team-under-box-button text-white"><i className="fa fa-plus" aria-hidden="true"></i></div><img className="img-fluid" src="images/1.jpg" alt="1" />
                ...
                <div className="item">
                  <div className="team-box">
                    <div className="team-under-box">
                      <div className="team-under-box-button text-white"><i className="fa fa-plus" aria-hidden="true"></i></div><img className="img-fluid" src="images/2.jpg" alt="2" />
                      <div className="team-overlay">
                        <div className="social-icon">
                          <ul>
                            <li><i className="fa fa-facebook" aria-hidden="true"></i></li>
                ...
                <div className="item">
                  <div className="team-box">
                    <div className="team-under-box">
                      <div className="team-under-box-button text-white"><i className="fa fa-plus" aria-hidden="true"></i></div><img className="img-fluid" src="images/3.jpg" alt="3" />
                      <div className="team-overlay">
                        <div className="social-icon">
                          <ul>
                            <li><i className="fa fa-facebook" aria-hidden="true"></i></li>
              ...
              <div className="team-hover">
                <div className="row">
                  <div className="col-md-4">
                    <div className="team-profile"><img className="img-fluid" src="images/1.jpg" alt="1" /></div>
                  </div>

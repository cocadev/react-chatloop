       ...
       <div class="container"><a class="navbar-brand" href="index.html"><img src="images/logo.png" alt="logo" /></a>
         ...
         <div class="collapse navbar-collapse" id="mainmenu">
           <ul class="navbar-nav ml-auto" id="mymenu">
             ...
             <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#news" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog </a>
             ...
             <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Other Page </a>
               <ul class="dropdown-menu">
     ...
     <section class="theme-bg feature" id="feature">
       <div class="container">
         ...
         <div class="row">
           <div class="col-md-12 text-center">
             <div class="section-title">
               <h2 class="text-white">Chat Loop Feature </h2>
                 ...
                 <div class="col-md-8">
                   <div class="d-flex-1">
                     <div class="hover-text">
                       ...
                       <h3>Mark Jecno </h3>
                       <h4 class="m-0 text-muted">Devloper & Designer </h4>
     ...
     <section class="theme-bg" id="package">
       <div class="container">
         <div class="row">
           <div class="col-md-12 text-center">
             <div class="section-title">
               <h2 class="text-white">Our Pricing Plans </h2>
               <div class="line white"></div>
             </div>
           </div>
           <div class="col-md-12 text-center">
               ...
               <div class="item">
                 <div class="package-box">
                   ...
                   <div class="price-box"><span>$ </span>
                     <h2>49 </h2>
                     <h5 class="plan-clr"><span class="d-block">Year </span></h5>
                   </div>
                   <div class="price-plan text-center">
                     ...
                     <div class="price-plan-btn">Select Plan </div>
                   </div>
                 </div>
               </div>
               <div class="item">
             ...
             <div class="accordion" id="accordionExample">
               <div class="card mb-3">
                 <div class="card-header" id="headingzero">
                   <h5 class="mb-0">
                     <button class="faq-link" type="button" data-toggle="collapse" data-target="#collapsezero" aria-expanded="false" aria-controls="collapsezero">01 We're ready to _____ now <i class="fa fa-angle-down pull-right"></i></button>
                   </h5>
                 </div>
                 <div class="collapse" id="collapsezero" aria-labelledby="headingzero" data-parent="#accordionExample">
                   <div class="card-body">Lorem ipsum dolor sit ____, consectetur adipisicing elit, sed __ ei temporo incididunt ut ______ et dolore magna aliqua. __ enim ad minim exercitation _______ laboris nisi ut aliquip __ ea commodo consequat. Duis ____ dolor in reprehenderit in _________ velit esse cillum dolore </div>
                 </div>
               </div>
               <div class="card mb-3">
                 <div class="card-header" id="headingOne">
                   <h5 class="mb-0">
                     <button class="faq-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">02 Sedeiusmod tm inccsetetur ? <i class="fa fa-angle-down pull-right"></i></button>
                   </h5>
                 </div>
               ...
               <div class="card mb-3">
                 <div class="card-header" id="headingTwo">
                   <h5 class="mb-0">
                     <button class="faq-link" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">03 Sedeiusmod inc aliquatraiy? <i class="fa fa-angle-down pull-right"></i></button>
                   </h5>
                 </div>
               ...
               <div class="card">
                 <div class="card-header" id="headingThree">
                   <h5 class="mb-0">
                     <button class="faq-link" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">04 Tempor inc aliquatraiy? <i class="fa fa-angle-down pull-right"></i></button>
                   </h5>
                 </div>
           ...
           <div class="col-md-12">
             <div class="news-slider owl-carousel owl-theme">
               <div class="item news-slid">
                 ...
                 <div class="news-text">
                   <p>lorem ipsum dolor sit ____, consecteturamet adipisicing elit, tempor __________ ut labore. lorem ipsum _____ sit amet. </p><a class="btn-theme" href="blog-details.html">View more </a>
                 </div>
               </div>
               <div class="item news-slid">
           ...
           <div class="col-md-6">
             ...
             <form class="auth-form">
               <div class="form-group">
                 <label for="exampleInputName1">Name </label><i class="fa fa-user"></i>
                 <input class="form-control" id="exampleInputName1" required="" name="login[username]" type="email" placeholder="User name" />
               </div>
               <div class="form-group">
                 <label for="exampleInputEmail12">Email </label><i class="fa fa-envelope-o"></i>
                 <input class="form-control" id="exampleInputEmail12" required="" name="login[email]" type="email" placeholder="Email" />
               </div>
               <div class="form-group">
                 <label>Your message </label><i class="fa fa-commenting-o"></i>
           ...
           <div class="col-sm-12 col-lg-8">
             <div class="email-box">
               <form class="auth-form needs-validation" id="mc-embedded-subscribe-form" action="https://pixelstrap.us19.list-manage.com/subscribe/post?u=5a128856334b598b395f1fc9b&amp;id=082f74cbda" method="post" name="mc-embedded-subscribe-form" target="_blank">
                 <input class="form-control" id="mce-EMAIL" name="EMAIL" placeholder="Your email address:" type="email" required="required" />
